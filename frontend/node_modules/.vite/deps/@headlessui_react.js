...
function F(n17, r20 = {}, e8, a27, s17) {
  ...
  if (t13 === import_react46.Fragment && (Object.keys(m2(o21)).length > 0 || Object.keys(m2(u24)).length > 0))
    if (!(0, import_react46.isValidElement)(f24) || Array.isArray(f24) && f24.length > 1) {
...
function c2({ children: t13 }) {
  ...
  if (!e8)
    return import_react51.default.createElement(import_react51.default.Fragment, null, t13);
  let { target: r20 } = e8;
